    ...
    submit (formName) {
      ...
      this.$refs[formName].validate(async (valid) => {
        if (valid) {
          ...
          this.$store.state.cardIsShow = false
        } else {
          return false
        }
      })
