        ...
        <el-header class="header-home" v-show="!isLogin">
          ...
          <div class="user fr main-col">
            ...
            <span class="el-dropdown-link" style="cursor: pointer;">
              <i class="iconfont icon-user-5"
                 style="margin-right: 5px;font-size: 18px"></i>{{ $store.state.userInfo.agentName }}<i
              class="el-icon-arrow-down el-icon--setting"></i>
            </span>
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item command="a">重置密码</el-dropdown-item>
<!--                <el-dropdown-item command="b">修改银行卡</el-dropdown-item>-->
...
export default {
  ...
  methods: {
    ...
    handleSelect (key, keyPath) {
      ...
      if (key === 'newsUpdate' && this.$store.state.activeIndex !== 'newsUpdate') {
        return
      }
    ...
    async handleCommand(command) {
      ...
      if (command === 'a') {
        ...
        this.$store.state.cardIsShow = true
      } else {
